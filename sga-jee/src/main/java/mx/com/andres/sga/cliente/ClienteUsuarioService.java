...
import mx.com.andres.sga.servicio.UsuarioServiceRemote;
...
public static void main(String[] args) {
		...
		try {
			...
			Context jndi = new InitialContext();
			 ...
			 jndi.lookup("java:global/sga-jee/UsuarioServiceImpl!mx.com.andres.sga.servicio.UsuarioServiceRemote");
